...
import outputSample1 from '../../public/images/drawline/drawline_output/output_1.png';
import outputSample2 from '../../public/images/drawline/drawline_output/output_2.png';
import outputSample3 from '../../public/images/drawline/drawline_output/output_3.png';
        ...
        <div onClick={onClickBox} className="output-image-banner-box">
            ...
            </div>
            {
                cartoonize_image_list.map((v, i) => (
                    <div 
                        key={i}
                        className={`${input_image_type===img_type_obj.CARTOONIZED_IMAGE&&input_image_idx===i+3?'single-image-wrapper on':'single-image-wrapper'}`}
                    >
